...
- [x] 예약이 취소될 때 대기 순번의 1번이 예약으로 바뀐다. (사이클2)
    - 예약 취소 -> 예약 대기 슬롯 확인 -> 대기 순번의 1번을 예약 추가 -> 대기 순번 1번 삭제 (사이클2)

- [ ] 예약을 변경할 때 예약이 존재하는 경우 예약된 슬롯에 대기를 신청할 수 있다. (사이클2)
    - [ ] 변경된 예약의 가장 빠른 대기 순번이 예약된다. (사이클2)
