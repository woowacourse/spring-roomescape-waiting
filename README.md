...
| RP9  | 이미 취소된 예약을 변경하려는 경우                     | 409 Conflict              | 이미 취소된 예약입니다.         |
...
```json
{
  ...
  "timeId": 1,
  "themeId": 4,
  "canceledAt": "2026-05-15T21:50:00"
}
```
...
5. 취소된 예약은 예약 점유로 보지 않습니다.
6. 삭제된 예약 시간에 연결된 기존 예약은 예약 가능 여부 계산에 반영하지 않습니다.
7. 예약 가능한 시간이 없으면 빈 목록을 반환합니다.
```
