...
- [ ] 확정된 예약을 관리자가 취소할 수 있다.
  - [ ] 예약 당일 1일 전 (자정)까지만 가능하고 예약 당일에는 취소가 불가능하다.
...
- 예약 관리 (관리자 권한 회원)
  - [ ] 예약 대기 목록을 조회할 수 있다.
    - [ ] 테마, 날짜, 시간 별로 1번째 예약자만 조회된다. 
  - [ ] 예약자가 24시간 전에 예약 취소할 경우 1번째 예약 대기자가 자동으로 예약 확정된다.
  - [ ] 대기 상태의 예약을 승인 또는 거절 할 수 있다.
    - [ ] 확정된 예약이 있을 경우 승인할 수 없다.
