...
- [x] 예약이 취소될 때 첫 번째 대기가 예약으로 승격한다. (사이클2)
    - 예약 취소 이후 -> 예약 대기 슬롯 확인 -> 대기 순번의 1번을 예약 추가 -> 대기 순번 1번 삭제 (사이클2)

- [x] 예약이 변경되면 기존 자리의 첫 번째 대기가 예약으로 승격한다. (사이클2)
    - 예약 변경 이후 -> 예약 대기 슬롯 확인 -> 대기 순번의 1번을 예약 추가 -> 대기 순번 1번 삭제 (사이클2)
