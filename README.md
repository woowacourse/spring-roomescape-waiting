...
- [x] 내 예약 목록을 조회하는 API 구현
  ...
  - [x] 로그인이 되어 있지 않으면 빈 목록이 조회된다.
- [x] 예약 대기 요청 기능 API 구현
  - [x] 이미 대기 기록이 있는 경우 예외 발생
  - [x] 예약이 존재하지 않은데 대기를 하려고 하는 경우 예외발생
- [x] 예약 대기 취소 기능 API 구현.
- [x] 내 예약 목록 조회 시 예약 대기 목록도 함께 포함.
  - [x] 대기인 경우 몇 번째 대기인지 함께 출력
- [x] 어드민에서 예약 대기 관리 기능을 구현.
  - [x] 어드민은 예약 대기 목록을 조회
    - [x] 오늘 시간을 기준으로 미래 예약에 대해서만 조회한다.
  - [x] 어드민은 예약 대기를 취소 가능
  - [x] 예약 대기 승인 가능
    - [x] 기존 예약이 존재하는 경우 예외 발생
