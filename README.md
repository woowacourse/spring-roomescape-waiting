...
페어 : [스타크](https://github.com/MODUGGAGI), [피노](https://github.com/haechanmoon)
...
<details>
<summary>기존 기능 요구 사항 펼쳐보기</summary>
...
<details>
<summary>사용자 대기 요구 사항 펼쳐보기(새로운 요구사항만 추가)</summary>

- [x] 예약된 슬롯에 대기 신청
    - 같은 슬롯에 대한 대기는 신청 순서대로 순번 부여
    - 같은 슬롯에 중복 대기 신청 X
- [x] 사용자는 본인의 대기 취소 가능 (이름으로 취소 가능)
- [x] 확정된 예약 취소 시 대기 중인 첫번째 예약 확정 예약으로 승격 기능
- [x] 확정된 예약 변경 시 대기 중인 첫번째 예약 확정 예약으로 승격 기능
- [x] 내 예약 목록 조회
...
<details>
<summary>기존 API 명세서 펼쳐보기</summary>
...
> `steps`는 현재 대기 순번을 기준으로 뒤로 미룰 칸 수이며, 본인보다 뒤에 있는 순번까지만 미룰 수 있다.
