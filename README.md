...
- [x] 컨트롤러 추가
    - [x] 순번 조회 `int waitingNumber(@RequestBody WaitingRequest waitingRequest)`
    - [x] 삽입 `void apply(@RequestBody WaitingRequest waitingRequest)`
    - [x] 삭제 `void cancel(@RequestBody WaitingRequest waitingRequest)`
