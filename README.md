...
6. 예약 대기 기능 관련
    ...
    - [x] 어드민 예약 대기 관리 기능 구현
        - 뷰 리소스: templates/waiting.html
            - [x] 어드민 예약 대기 조회 및 거절 기능 구현
                - 어드민 예약 대기 목록 조회 시, 사용자의 예약 대기 내역을 조회할 수 있게 한다
                - 어드민 예약 대기 삭제 시, 사용자의 예약 대기 내역을 취소할 수 있게 한다
            - [x] 어드민 예약 대기 승인 기능 구현
                - 어드민이 승인 버튼을 누르면, 사용자의 예약 대기 내역을 직접 승인할 수 있게 한다
                - 어드민 예약 대기 승인 시, 사용자의 해당 예약 대기 내역이 삭제되고, 예약 내역으로 저장되게 한다
