...
- [x] 예약 대기 요청 기능 구현
    - [x] GET `/reservations/wait` API 통해 예약 대기 기능 구현
    - [x] 중복 예약이 불가능 하도록 구현
- [x] 예약 대기 취소 기능 구현
    - [x] DELETE `/reservation-mine` API 통해 예약 대기 취소 기능 구현
    - [x] 예약이 취소되면 최우선 순위 예약 대기가 예약 상태로 변경 기능 구현
- [x] 내 예약 목록 조회 기능 구현
    - [x] GET `reservation-mine` API 통해 내 예약 목록 조회
    - 조회시 예약 대기 정보 포함

### 예약 대기 관리

어드민 페이지는 어드민 권한을 가진 사용자만 접근할 수 있습니다.  
예약 대기 목록은 예약 대기 상태인 예약 대기만 조회할 수 있습니다.  
(예약 상태는 조회하지 않습니다. GET `/admin/reservation` API를 통해 조회할 수 있습니다.)

- [x] 어드민 페이지 예약 대기 조회 기능 구현
    - [x] GET `admin/waiting` API 통해 예약 대기 목록을 조회 기능 구현
