...
- [ ] 이미 예약되어있는 경우, 대기할 수 있다.
- [ ] 동시에 예약하려는 경우, 대기하지 않고 실패한다. (예약과 대기는 서로 다르게 처리한다)
- [ ] 예약이 취소되면 대기 중인 예약이 자동으로 예약된다.
- [ ] 예약 대기를 취소할 수 있다. 이때, 뒤쪽 예약 사람들의 순번이 줄어든다.
- [ ] 사용자가 예약 조회를 할 때, 몇 번째 대기 순번인지 확인할 수 있다.
- [ ] 대기 순번은 최대 5명까지이다.
