...
VALUES ('두둠', 1, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('이프', 2, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('이프', 3, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('이프', 4, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('도윤', 5, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('서윤', 6, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('하준', 7, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('지우', 8, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('시우', 9, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('하윤', 10, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('예준', 11, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('서준', 12, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('지안', 13, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('수아', 14, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('이준', 15, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('서아', 16, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('하린', 17, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('지민', 18, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('윤우', 19, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('채원', 20, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP),
       ('은우', 21, 'RESERVED', 'ACTIVE', CURRENT_TIMESTAMP);
