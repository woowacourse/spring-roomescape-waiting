...
FROM (VALUES ('member1', DATEADD('DAY', -8, CURRENT_DATE), '09:00:00', '인기 테마 1',
             ...
             ('inactive-member3', DATEADD('DAY', -6, CURRENT_DATE), '10:00:00', '비활성 인기 테마',
              DATEADD('DAY', -6, CURRENT_TIMESTAMP), 'RESERVED')) AS v(name, reservation_date,
                                                                       start_at, theme_name,
                                                                       requested_at, status)
