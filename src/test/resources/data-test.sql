...
VALUES (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 1, 'RESERVED'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 2, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 3, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 4, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 5, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 6, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 3, 2, 'RESERVED'),
       (CURRENT_DATE + INTERVAL '1' DAY , 2, 3, 2, 'RESERVED'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 4, 3, 'RESERVED'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 3, 3, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 5, 2, 'RESERVED'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 5, 3, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 2, 2, 'RESERVED'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 1, 3, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 1, 3, 3, 'WAITING'),
       (CURRENT_DATE + INTERVAL '2' DAY , 2, 2, 2, 'RESERVED');
