...
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 2, 2);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -5, CURRENT_DATE), 3, 3, 3);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -7, CURRENT_DATE), 1, 1, 4);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -1, CURRENT_DATE), 1, 2, 5);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 3, 1);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -5, CURRENT_DATE), 3, 1, 2);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -7, CURRENT_DATE), 1, 2, 3);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -1, CURRENT_DATE), 1, 3, 4);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 1, 5);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -5, CURRENT_DATE), 3, 2, 1);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -7, CURRENT_DATE), 1, 3, 2);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -1, CURRENT_DATE), 1, 1, 3);
INSERT INTO reservation(date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 2, 4);
