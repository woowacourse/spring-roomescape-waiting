...
INSERT INTO reservation_detail(date, time_id, theme_id) VALUES (DATEADD('DAY', -7, CURRENT_DATE), 1, 5);
...
INSERT INTO reservation_detail(date, time_id, theme_id) VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 3);
