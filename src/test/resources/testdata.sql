...
VALUES (1, '2025-05-04', 1, 1, 'OVERDUE'),
       (1, '2025-05-04', 5, 2, 'OVERDUE'),
       (1, '2025-05-04', 6, 2, 'OVERDUE'),
       (2, '2025-05-05', 3, 3, 'OVERDUE'),
       (2, '2025-05-05', 1, 3, 'OVERDUE'),
       (2, '2025-05-04', 2, 3, 'OVERDUE'),
       (3, '2025-05-04', 1, 4, 'OVERDUE'),
       (3, '2025-05-04', 1, 5, 'OVERDUE');
