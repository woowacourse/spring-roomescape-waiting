...
VALUES (1, '2024-04-05', 1, 1, 1, 'RESERVED'),
       (2, '2024-04-06', 2, 2, 1, 'RESERVED'),
       (3, '2024-04-06', 2, 3, 2, 'RESERVED'),
       (4, '2024-04-07', 1, 2, 2, 'RESERVED'),
       (5, '2024-04-07', 2, 2, 3, 'RESERVED'),
       (6, '2024-04-08', 1, 2, 3, 'RESERVED'),
       (7, '2024-04-08', 2, 3, 3, 'RESERVED'),
       (8, '2024-04-09', 1, 4, 4, 'RESERVED'),
       (9, '2024-04-10', 1, 1, 4, 'RESERVED'),
       (10, '2024-04-10', 2, 2, 4, 'RESERVED'),
       (11, '2024-04-11', 1, 2, 4, 'RESERVED');
