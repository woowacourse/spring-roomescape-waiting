...
VALUES (1, '2024-04-5', 1, 1, 1, 'RESERVED'),
       (2, '2024-04-6', 2, 2, 1, 'RESERVED'),
       (3, '2024-04-6', 2, 3, 2, 'RESERVED'),
       (4, '2024-04-7', 1, 2, 2, 'RESERVED'),
       (5, '2024-04-7', 2, 2, 3, 'RESERVED'),
       (6, '2024-04-8', 1, 2, 3, 'RESERVED'),
       (7, '2024-04-8', 2, 3, 3, 'RESERVED'),
       (8, '2024-04-9', 1, 4, 4, 'RESERVED'),
