...
class ReservationUpdateRequestTest {
    ...
    void 모든_값이_유효하면_위반이_없다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest(VALID_NAME, VALID_DATE, VALID_TIME_ID);
    ...
    void 이름이_null이면_위반이_발생한다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest(null, VALID_DATE, VALID_TIME_ID);
    ...
    void 이름이_빈문자열이면_위반이_발생한다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest("", VALID_DATE, VALID_TIME_ID);
    ...
    void 날짜가_null이면_위반이_발생한다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest(VALID_NAME, null, VALID_TIME_ID);
    ...
    void 시간_ID가_null이면_위반이_발생한다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest(VALID_NAME, VALID_DATE, null);
    ...
    void 시간_ID가_0이면_위반이_발생한다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest(VALID_NAME, VALID_DATE, 0L);
    ...
    void 시간_ID가_음수이면_위반이_발생한다() {
        ReservationUpdateRequest request = new ReservationUpdateRequest(VALID_NAME, VALID_DATE, -1L);
