...
class ReservationControllerTest {
    ...
    void createAdminReservation() {
        // given
        String accessToken = getTokenByLoginRequest(ADMIN_ZEZE);
        Map<String, Object> reservationRequest = createReservationRequest(
                ADMIN_ZEZE, VALID_STRING_DATE,
                RESERVATION_TIME_10AM, ROOM_THEME1);
    ...
    private Map<String, Object> createReservationRequest(
            Member member, String date,
            ReservationTime time, RoomTheme theme)
    {
    ...
    private String getTokenByLoginRequest(Member member) {
        Member savedMember = memberRepository.save(member);

        return RestAssured
                .given().log().all()
                .body(new LoginRequest(savedMember.getEmail(), savedMember.getPassword()))
