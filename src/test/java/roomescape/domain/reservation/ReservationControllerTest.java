...
class ReservationControllerTest {
    ...
    void createReservation_Fail_Duplicated() {
        reservationRepository.save(Reservation.createWithoutId("기존테스터", futureDate, time, theme));
    ...
    void getReservationsByName() {
        reservationRepository.save(Reservation.createWithoutId("테스터", futureDate, time, theme));
    ...
    void cancelReservation() {
        Reservation saved = reservationRepository.save(Reservation.createWithoutId("취소테스터", futureDate, time, theme));
    ...
    void cancelReservation_Fail_Today() {
        Reservation saved = reservationRepository.save(Reservation.createWithoutId("취소불가테스터", todayDate, time, theme));
    ...
    void updateReservation() {
        Reservation saved = reservationRepository.save(Reservation.createWithoutId("수정테스터", futureDate, time, theme));
    ...
    void updateReservation_Fail_Today() {
        Reservation saved = reservationRepository.save(Reservation.createWithoutId("당일예약테스터", todayDate, time, theme));
    ...
    void updateReservation_Fail_Duplicated() {
        Reservation myReservation = reservationRepository.save(
                Reservation.createWithoutId("내예약", futureDate, time, theme));

        ReservationDate otherDate = reservationDateRepository.save(
                ReservationDate.createWithoutId(LocalDate.now().plusDays(15)));
        reservationRepository.save(Reservation.createWithoutId("다른사람예약", otherDate, time, theme));
