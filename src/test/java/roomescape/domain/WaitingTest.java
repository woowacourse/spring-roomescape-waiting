...
class WaitingTest {
    ...
    void 지난_날짜에_대한_예약_대기라면_예외가_발생한다(LocalDateTime currentDateTime, LocalDateTime reservationDateTime) {
        //when & then
    ...
    void 예약_대기일이_오늘인_경우_예약_시간까지_10분도_남지_않았다면_예외가_발생한다(LocalDateTime currentDateTime,
