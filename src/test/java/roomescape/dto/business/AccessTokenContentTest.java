...
class AccessTokenContentTest {
    ...
    public class isAdminToken {
        ...
        void isAdmin() {
            // given
            AccessTokenContent adminTokenContent = new AccessTokenContent(1L, Role.ROLE_ADMIN, "관리자");
        ...
        void isMember() {
            // given
            AccessTokenContent memberTokenContent = new AccessTokenContent(1L, Role.ROLE_MEMBER, "관리자");
