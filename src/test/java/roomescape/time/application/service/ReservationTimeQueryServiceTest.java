...
class ReservationTimeQueryServiceTest {
    ...
    void getReservationTime() {
        ...
        final ReservationTime savedTime = reservationTimeRepository.save(ReservationTime.withoutId(TimeValue.from(time)));
    ...
    void getAllReservationTimes() {
        // given
        reservationTimeRepository.save(ReservationTime.withoutId(TimeValue.from(LocalTime.of(10, 0))));
        reservationTimeRepository.save(ReservationTime.withoutId(TimeValue.from(LocalTime.of(11, 0))));
