...
import roomescape.business.service.application.AuthService;
...
class AuthServiceTest {
    ...
    void 올바른_이메일과_비밀번호로_인증에_성공한다() {
        ...
        User user = User.member("Test User", email, password);
    ...
    void 잘못된_비밀번호로_인증_시_예외가_발생한다() {
        ...
        User user = User.member("Test User", email, encodedPassword);
