...
class WaitingTest {
    ...
    void MemberWhoWaitsHasDeleteAuth() {
        boolean hasDeleteAuth = WAITING_1.isNotDeletableBy(MEMBER_2);
    ...
    void AdminHasDeleteAuth() {
        boolean hasDeleteAuth = WAITING_1.isNotDeletableBy(ADMIN);
    ...
    void NotRelatedMemberCanNotDeleteWaiting() {
        boolean hasDeleteAuth = WAITING_1.isNotDeletableBy(MEMBER_1);
