...
class ReservationTest {
    ...
    void MemberWhoReservatedHasDeleteAuth() {
        boolean hasDeleteAuth = RESERVATION_1.isNotDeletableBy(MEMBER_1);
    ...
    void AdminHasDeleteAuth() {
        boolean hasDeleteAuth = RESERVATION_1.isNotDeletableBy(ADMIN);
    ...
    void NotRelatedMemberCanNotDeleteReservation() {
        boolean hasDeleteAuth = RESERVATION_1.isNotDeletableBy(MEMBER_2);
