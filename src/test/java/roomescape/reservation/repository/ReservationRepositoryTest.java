...
class ReservationRepositoryTest {
        ...
        void 예약_저장() {
                ...
                final Reservation reservation = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 25), reservationTime,
                                theme));
        ...
        void 테마와_멤버와_날짜사이에_있는_예약_조회() {
                ...
                final Reservation reservation1 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 11, 25), reservationTime,
                                theme));
                final Reservation reservation2 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 26), reservationTime,
                                theme));
        ...
        void 일주일_이내의_인기있는_예약_테마_정보_조회() {
                ...
                final Reservation reservation1 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 15), reservationTime,
                                theme1));
                final Reservation reservation2 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 18), reservationTime,
                                theme1));
                final Reservation reservation3 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 23), reservationTime,
                                theme1));
                final Reservation reservation4 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 22), reservationTime,
                                theme2));
                final Reservation reservation5 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 24), reservationTime,
                                theme2));
                reservationRepository.save(reservation1);
                reservationRepository.save(reservation2);
        ...
        void 멤버_기준으로_예약_조회() {
                ...
                final Reservation reservation1 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 25), reservationTime,
                                theme));
                final Reservation reservation2 = new Reservation(member, new ReservationSlot(LocalDate.of(2025, 12, 26), reservationTime,
                                theme));
                reservationRepository.save(reservation1);
