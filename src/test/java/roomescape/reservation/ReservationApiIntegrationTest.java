...
public class ReservationApiIntegrationTest extends ControllerTestSupport {
    ...
    @Test
    @DisplayName("미션 원문 경로로 나의 예약 목록을 조회할 수 있다.")
    void finds_my_reservations_with_mission_path_successfully() {
        String accessToken = loginUserToken();
    ...
    @Test
    @DisplayName("나의 예약 목록에서 예약과 대기를 함께 조회한다.")
    void my_reservation_list_includes_reserved_and_waiting_items() {
        String accessToken = loginWaitingUserToken();
