...
class ReservationJpaRepositoryTest {
    ...
    @DisplayName("맴버의 id로 예약과 맴버를 함꼐 조회한다")
    @Test
    void findAllWithMember() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            softAssertions.assertThat(reservationWithMember).isPresent();
