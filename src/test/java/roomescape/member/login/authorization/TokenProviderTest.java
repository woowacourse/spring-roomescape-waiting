...
//        setField(tokenProvider, "secretKey", TEST_SECRET_KEY);
//    }
//
...
//
//        String extractedEmail = tokenProvider.getPayloadEmail(token);
//
...
//        String token = tokenProvider.createToken(TEST_EMAIL, TEST_ROLE);
//
//        String extractedRole = tokenProvider.getPayloadRole(token);
//
