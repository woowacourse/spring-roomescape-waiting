...
public class ThemeFixture {
    ...
    public static final ThemeRequest DEFAULT_REQUEST = new ThemeRequest(
            DEFAULT_THEME.getName(),
            DEFAULT_THEME.getDescription(),
            DEFAULT_THEME.getThumbnail()
    );

    public static final ThemeResponse DEFAULT_RESPONSE = new ThemeResponse(
            DEFAULT_THEME.getId(),
            DEFAULT_THEME.getName(),
            DEFAULT_THEME.getDescription(),
            DEFAULT_THEME.getThumbnail()
