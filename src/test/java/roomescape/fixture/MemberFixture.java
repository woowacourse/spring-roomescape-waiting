...
public class MemberFixture {
    ...
    public static final Member ADMIN_MEMBER = new Member(null, "어드민", ADMIN_EMAIL, ADMIN_PASSWORD, ADMIN);

    public static final String MEMBER_EMAIL = "dodo@gmail.com";
    public static final String MEMBER_PASSWORD = "123123";
    public static final Member MEMBER_MEMBER = new Member(null, "도도", MEMBER_EMAIL, MEMBER_PASSWORD, MEMBER);
}
