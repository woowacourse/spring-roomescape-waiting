...
public class Fixture {
    ...
    public static final Member VALID_ADMIN = new Member(VALID_ADMIN_NAME,VALID_ADMIN_EMAIL,VALID_ADMIN_PASSWORD,MemberRole.ADMIN);
    public static final Reservation VALID_RESERVATION = new Reservation(VALID_MEMBER, VALID_RESERVATION_DATE,
        VALID_RESERVATION_TIME, VALID_THEME, ReservationStatus.RESERVED);
