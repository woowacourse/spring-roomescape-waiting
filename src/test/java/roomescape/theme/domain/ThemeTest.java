...
class ThemeTest {
    ...
    void create_fail_whenNameIsBlank() {
        assertInvalidRequestException(
                () -> Theme.create(" ", "우테코 레벨2를 탈출하는 내용입니다.", "https://example.com/theme.png")
        );
    }
    ...
    void create_fail_whenDescriptionIsBlank() {
        assertInvalidRequestException(
                () -> Theme.create("레벨2 탈출", " ", "https://example.com/theme.png")
        );
    }
    ...
    void create_fail_whenThumbnailIsBlank() {
        assertInvalidRequestException(
                () -> Theme.create("레벨2 탈출", "우테코 레벨2를 탈출하는 내용입니다.", " ")
        );
    }
    ...
    void withId_fail_whenIdIsNull() {
        Theme theme = Theme.create("레벨2 탈출", "우테코 레벨2를 탈출하는 내용입니다.", "https://example.com/theme.png");
