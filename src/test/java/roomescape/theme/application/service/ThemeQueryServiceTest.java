...
class ThemeQueryServiceTest {
    ...
    void getAll() {
        ...
        final Theme saved1 = themeRepository.save(Theme.of(
        ...
        final Theme saved2 = themeRepository.save(Theme.of(
    ...
    void getRanking() {
        ...
        final ReservationTime time = reservationTimeRepository.save(
                ReservationTime.of(LocalTime.of(12, 0)));
