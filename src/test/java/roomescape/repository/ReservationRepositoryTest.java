...
class ReservationRepositoryTest {
    ...
    void 예약_추가_테스트() {
        ...
        Reservation reservation = new Reservation(null, "브라운", new ReservationSlot(date, time, theme));
    ...
    void 예약_삭제_테스트() {
        ...
        Reservation reservation1 = new Reservation(null, "브라운", new ReservationSlot(date, time1, theme1));
        Reservation reservation2 = new Reservation(null, "구구", new ReservationSlot(date, time2, theme2));
    ...
    void 이름에_해당하는_예약_목록을_조회한다() {
        ...
        Theme theme1 = new Theme(1L, "테마 이름1", "테마 설명1", "썸네일1");
        Theme theme2 = new Theme(2L, "테마 이름2", "테마 설명2", "썸네일2");
        reservationRepository.insert(new Reservation(null, "브라운", new ReservationSlot(date, time1, theme1)));
        reservationRepository.insert(new Reservation(null, "브라운", new ReservationSlot(date.plusDays(1), time2, theme2)));
        reservationRepository.insert(new Reservation(null, "구구", new ReservationSlot(date, time2, theme2)));
    ...
    void 예약의_날짜와_시간을_변경한다() {
        ...
        Theme theme = new Theme(1L, "테마 이름", "테마 설명", "썸네일");
        Long id = reservationRepository.insert(new Reservation(null, "브라운", new ReservationSlot(date, time, theme))).getId();
        LocalDate updateDate = date.plusDays(1);

        Reservation updatedReservation = new Reservation(id, "브라운", new ReservationSlot(updateDate, updateTime, theme));
    ...
    void 날짜_시간_테마에_해당하는_예약이_존재하는지_확인한다() {
        ...
        Theme theme = new Theme(1L, "테마 이름", "테마 설명", "썸네일");
        reservationRepository.insert(new Reservation(null, "브라운", new ReservationSlot(date, time, theme)));
