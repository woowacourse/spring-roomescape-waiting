...
class ReservationRepositoryTest {
    ...
    @Test
    void create() {
        final var reservation = sut.save(ReservationInfo.from("2024-10-10", time, theme, member));
    ...
    @Test
    void getAll() {
        sut.save(ReservationInfo.from("2024-10-10", time, theme, member));
        sut.save(ReservationInfo.from("2024-10-11", time, theme, member));
    ...
    void get_reservation_themeId_memberId_between_reservationDate() {
        ...
        sut.save(ReservationInfo.from("2024-10-08", time, theme, member));
        sut.save(ReservationInfo.from("2024-10-09", time, theme, member));
        sut.save(ReservationInfo.from("2024-10-10", time, theme, member));
        sut.save(ReservationInfo.from("2024-10-11", time, theme, newMember));
        final var result =
    ...
    void find_all_by_member_id() {
        ...
        sut.save(ReservationInfo.from("2024-10-08", time, theme, member));
        sut.save(ReservationInfo.from("2024-10-09", time, theme, member));
        sut.save(ReservationInfo.from("2024-10-10", time, theme, newMember));
