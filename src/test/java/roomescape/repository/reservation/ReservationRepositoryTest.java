...
class ReservationRepositoryTest {
    ...
    void countByDateAndTimeAndThemeTest() {
        ...
        for (int i = 0; i < 3; i++) {
            Reservation reservation = new Reservation(date, time, theme1, member, ReservationStatus.CONFIRMED,
                    LocalDateTime.now());
            entityManager.persist(reservation);
        }

        Reservation otherDateReservation = new Reservation(date.plusDays(1), time, theme1, member,
