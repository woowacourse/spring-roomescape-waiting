...
public class ReservationJdbcDaoTest {
    ...
    void test5() {
        ...
        List<Reservation> result = reservationDao.findAll(
                new ReservationSearchDto(theme.getId(), null, null, null));
    ...
    void test6() {
        ...
        // when
        List<Reservation> result = reservationDao.findAll(
                new ReservationSearchDto(null, member.getId(), null, null));
    ...
    void test7() {
        ...
        // when
        List<Reservation> result = reservationDao.findAll(
                new ReservationSearchDto(null, null, searchDate, searchDate.plusDays(1)));
