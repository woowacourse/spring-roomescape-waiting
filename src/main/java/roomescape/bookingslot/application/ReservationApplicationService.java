...
public class ReservationApplicationService {
    ...
    public ReservationResponse create(final LocalDate date, final Long timeId, final Long themeId, final Long memberId,
        ...
        reservationDomainService.checkIfReservationDoesNotExists(date, timeId, themeId);
        ...
        BookingSlot newBookingSlot = reservationDomainService.save(member, date, time, theme, now);
