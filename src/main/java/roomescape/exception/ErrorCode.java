...
public enum ErrorCode {
    ...
    WAITING_NOT_ALLOWED_FOR_OWN_RESERVATION(HttpStatus.CONFLICT, "WAITING_409_OWN_RESERVATION", "본인이 예약한 슬롯에는 대기를 신청할 수 없습니다."),
    WAITING_NOT_OWNED_BY_MEMBER(HttpStatus.FORBIDDEN, "WAITING_403_OWNER", "본인 대기(%d번)만 처리할 수 있습니다."),
    WAITING_TARGET_BAD_REQUEST(HttpStatus.BAD_REQUEST, "WAITING_400_TARGET_BAD_REQUEST", "예약 또는 대기가 존재하는 슬롯에만 대기를 신청할 수 있습니다."),

    // Slot
    SLOT_NOT_FOUND_WITH_CONDITION(HttpStatus.NOT_FOUND, "SLOT_404_WITH_CONDITION", "해당 조건의 슬롯 id가 존재하지 않습니다. date=%s, timeId=%d, themeId=%d"),
