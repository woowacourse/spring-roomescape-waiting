...
public enum ErrorCode {
    ...
    UNALLOWED_UPDATE_PAST_RESERVATION("RESERVATION_400_7", "이미 지난 예약은 수정할 수 없습니다. ", HttpStatus.BAD_REQUEST),
    ...
    RESERVATION_SLOT_NULL("RESERVATION_400_10", "예약 슬롯은 null일 수 없습니다.", HttpStatus.BAD_REQUEST),
    RESERVATION_STATUS_NULL("RESERVATION_400_11", "예약 상태는 null 일 수 없습니다.", HttpStatus.BAD_REQUEST),
    RESERVATION_STATUS_UNAVAILABLE("RESERVATION_400_12","예약 확정 상태가 아닙니다.",HttpStatus.BAD_REQUEST),
    RESERVATION_DATE_UNAVAILABLE("RESERVATION_400_13","예약 변경 가능 시간이 아닙니다.",HttpStatus.BAD_REQUEST),
    ...
    NOT_EXIST_RESERVATION_SLOT("RESERVATION_SLOT_400","조건에 맞는 예약 슬롯이 없습니다.", HttpStatus.BAD_REQUEST),
