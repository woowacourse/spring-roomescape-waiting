...
public enum ErrorCode {
    ...
    THEME_NAME_BLANK("THEME_400", "테마 이름은 비거나 공백일 수 없습니다.", HttpStatus.BAD_REQUEST),
    THEME_DESCRIPTION_BLANK("THEME_400", "테마 설명은 비거나 공백일 수 없습니다.", HttpStatus.BAD_REQUEST),
    THEME_THUMBNAIL_URL_BLANK("THEME_400", "테마 썸네일 URL은 비거나 공백일 수 없습니다.", HttpStatus.BAD_REQUEST),
    ...
    RESERVATION_NAME_BLANK("RESERVATION_400", "예약자 이름은 비거나 공백일 수 없습니다.", HttpStatus.BAD_REQUEST),
