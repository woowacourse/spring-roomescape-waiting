...
public class JdbcWaitingReservationRepository implements WaitingReservationRepository {
    ...
    public WaitingReservation save(WaitingReservation waitingReservation) {
        ...
        return WaitingReservation.of(id, waitingReservation.getName(), waitingReservation.getDate(),
            waitingReservation.getTime(), waitingReservation.getTheme(), waitingReservation.getCreatedAt());
    }
    ...
    private RowMapper<WaitingReservation> waitingReservationRowMapper() {
        return (rs, rowNum) -> WaitingReservation.of(rs.getLong("id"), rs.getString("name"),
            ...
            Theme.of(rs.getLong("theme_id"), rs.getString("theme_name"), rs.getString("theme_content"),
                rs.getString("theme_url")), rs.getTimestamp("created_at").toLocalDateTime());
    }
