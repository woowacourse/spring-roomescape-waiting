...
public class AdminReservationController {
    ...
    @GetMapping
    public ResponseEntity<ReservationsResponse> getAllReservation(HttpServletRequest httpRequest) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteReservation(HttpServletRequest httpRequest, @PathVariable Long id) {
        if (validator.isUnauthorized(httpRequest)) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
        }
