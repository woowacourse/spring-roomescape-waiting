...
import roomescape.business.service.application.ReservationTimeService;
...
public class ReservationTimeApiController {
    ...
    public ResponseEntity<List<BookedReservationTimeResponse>> getAvailableReservationTimes(
        ...
        List<ReservableReservationTimeDto> reservationTimeDtos = timeReader.getAllWithAvailableBy(date, themeId);
