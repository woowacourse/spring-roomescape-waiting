...
public class CookieUtils {
    ...
    public void setCookieForToken(final HttpServletResponse response, final String token) {
        final Cookie cookie = new Cookie(COOKIE_NAME_FOR_TOKEN, token);
    ...
    public String getToken(final HttpServletRequest request) {
        ...
        final Cookie foundCookie = Arrays.stream(cookies)
    ...
    public boolean containsCookieForToken(final HttpServletRequest request) {
        final Cookie[] cookies = request.getCookies();
        if (cookies == null) {
            return false;
        }
