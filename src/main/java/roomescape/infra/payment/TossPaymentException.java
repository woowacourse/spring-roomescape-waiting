...
public class TossPaymentException extends RuntimeException {
    ...
    public static TossPaymentException of(HttpStatusCode status, TossErrorResponse error) {
        return switch (error.code()) {
            ...
            case "REJECT_CARD_PAYMENT" -> new PaymentRejected(error.message());
    ...
    public static class PaymentRejected extends TossPaymentException {

        public PaymentRejected(String message) {
