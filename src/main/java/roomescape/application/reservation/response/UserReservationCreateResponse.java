...
public record UserReservationCreateResponse(
        Long id,
        LocalDate date,
    ...
    public static UserReservationCreateResponse from(Reservation reservation) {
        return new UserReservationCreateResponse(
                reservation.getId(),
