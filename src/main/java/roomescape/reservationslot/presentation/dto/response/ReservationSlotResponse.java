...
public record ReservationSlotResponse(
    ...
    public static ReservationSlotResponse of(ReservationSlot reservationSlot, ReservationTime reservationTime, Theme theme,
                                             Member member) {
        return new ReservationSlotResponse(reservationSlot.getId(), MemberResponse.from(member), reservationSlot.getDate(),
