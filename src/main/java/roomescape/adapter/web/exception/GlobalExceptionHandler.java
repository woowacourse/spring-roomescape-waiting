package roomescape.adapter.web.exception;
...
import roomescape.exception.client.RoomEscapeClientException;
import roomescape.exception.server.RoomEscapeServerException;
...
public class GlobalExceptionHandler {
    ...
    // 4xx 클라이언트 예외 통합 처리
    @ExceptionHandler(RoomEscapeClientException.class)
    public ResponseEntity<ErrorResponse> handleClientException(RoomEscapeClientException e) {
        return ResponseEntity
