...
public record CreateReservationResponse(Long id, CreateMemberOfReservationResponse member, LocalDate date,
                                        CreateTimeOfReservationsResponse time, CreateThemeOfReservationResponse theme) {
