...
public class PendingReservation {
    ...
    public PendingReservation withId(final Long id) {
    ...
    public PendingReservation changeTime(String username, TimeSlot slot, Clock clock) {
    ...
    public PendingReservation cancel(String username, Clock clock) {
        checkChangeable(username, clock);
        slot.checkChangeableTime(clock);
        return PendingReservation.builder()
                .id(id)
