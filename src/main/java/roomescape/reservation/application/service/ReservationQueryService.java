...
import roomescape.reservation.application.dto.AvailableReservationTimeRequest;
...
public class ReservationQueryService {
    ...
    public List<AvailableReservationTimeResponse> getTimesWithBookedStatus(
    ...
    private AvailableReservationTimeResponse createAvailabilityResponse(final ReservationTime time,
        ...
        return new AvailableReservationTimeResponse(time, bookedStatus);
    }
}
