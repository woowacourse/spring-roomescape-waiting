...
import roomescape.repository.reservationmember.JpaReservationMemberRepository;
...
public class RepositoryConfig {
    ...
    public ReservationMemberRepository reservationMemberRepository(
            @Autowired JpaReservationMemberRepository jpaReservationMemberRepository) {
        return new ReservationMemberRepositoryImpl(jpaReservationMemberRepository);
    }
}
