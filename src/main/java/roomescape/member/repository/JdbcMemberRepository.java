...
public class JdbcMemberRepository implements MemberRepository {
    ...
    public Optional<Member> findById(Long id) {
        String sql = """
                ...
                """;
        try{
            return Optional.ofNullable(jdbcTemplate.queryForObject(sql, new MapSqlParameterSource("id", id), memberRowMapper));
    ...
    public Optional<Member> findByName(String name) {
        String sql = """
                ...
                """;
        try{
            return Optional.ofNullable(jdbcTemplate.queryForObject(sql, new MapSqlParameterSource("name", name), memberRowMapper));
        } catch (EmptyResultDataAccessException e) {
            return Optional.empty();
        }
    }
