...
const AVAILABLE_TIME_API_ENDPOINT = '/reservations/available-times'
...
function fetchAvailableTimes(date, themeId) {
    ...
    fetch(endPoint.toString(), { // 예약 가능 시간 조  회 API endpoint
        method: 'GET',
        headers: {
...
function renderAvailableTimes(times) {
    ...
    times.forEach(time => {
        const startAt = time.reservationTime.startAt;
        const timeId = time.reservationTime.id;
