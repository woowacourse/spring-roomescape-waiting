...
INSERT INTO reservation_slot (id, reservation_date, time_id, theme_id) VALUES (1, DATEADD('DAY', 1, CURRENT_DATE), 1, 1);
INSERT INTO reservation_slot (id, reservation_date, time_id, theme_id) VALUES (2, DATEADD('DAY', 1, CURRENT_DATE), 3, 2);
INSERT INTO reservation_slot (id, reservation_date, time_id, theme_id) VALUES (3, DATEADD('DAY', 2, CURRENT_DATE), 2, 3);
...
INSERT INTO reservation (customer_name, customer_email, slot_id, status) VALUES ('홍길동', 'hong@example.com', 1, 'CONFIRMED');
INSERT INTO reservation (customer_name, customer_email, slot_id, status) VALUES ('김철수', 'kim@example.com', 2, 'CONFIRMED');
INSERT INTO reservation (customer_name, customer_email, slot_id, status) VALUES ('이영희', 'lee@example.com', 3, 'CONFIRMED');
INSERT INTO reservation (customer_name, customer_email, slot_id, status) VALUES ('박민준', 'park@example.com', 4, 'CONFIRMED');
INSERT INTO reservation (customer_name, customer_email, slot_id, status) VALUES ('최지우', 'choi@example.com', 5, 'CONFIRMED');
