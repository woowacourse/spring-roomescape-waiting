...
INSERT INTO RESERVATION(MEMBER_ID, DATE, TIME_ID, THEME_ID, RANK)
VALUES (1, CURRENT_DATE - 3, 1, 1, 0),
       (2, CURRENT_DATE - 2, 3, 2, 0),
       (1, CURRENT_DATE - 1, 2, 2, 0),
       (2, CURRENT_DATE - 1, 1, 2, 0),
       (3, CURRENT_DATE - 7, 1, 3, 0),
       (3, CURRENT_DATE + 3, 4, 3, 0);
