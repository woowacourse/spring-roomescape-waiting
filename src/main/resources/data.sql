...
VALUES
-- theme_id 1: 10건
(CURRENT_DATE - 3, 13, 1, 2),
(CURRENT_DATE - 3, 12, 1, 3),
(CURRENT_DATE - 3, 11, 1, 4),
(CURRENT_DATE - 3, 10, 1, 5),
(CURRENT_DATE - 3, 9, 1, 6),
(CURRENT_DATE - 3, 8, 1, 7),
(CURRENT_DATE - 3, 7, 1, 8),
(CURRENT_DATE - 3, 6, 1, 9),
( CURRENT_DATE - 3, 5, 1, 1),
( CURRENT_DATE - 3, 4, 1, 1),

-- theme_id 2: 9건
(CURRENT_DATE - 2, 11, 2, 2),
(CURRENT_DATE - 2, 10, 2, 3),
(CURRENT_DATE - 2, 9, 2, 4),
(CURRENT_DATE - 2, 8, 2, 5),
(CURRENT_DATE - 2, 7, 2, 6),
(CURRENT_DATE - 2, 6, 2, 7),
(CURRENT_DATE - 2, 5, 2, 8),
(CURRENT_DATE - 2, 4, 2, 9),
(CURRENT_DATE - 2, 3, 2, 1),

-- theme_id 3: 8건
(CURRENT_DATE - 1, 9, 3, 2),
(CURRENT_DATE - 1, 8, 3, 3),
(CURRENT_DATE - 1, 7, 3, 4),
(CURRENT_DATE - 1, 6, 3, 5),
(CURRENT_DATE - 1, 5, 3, 6),
(CURRENT_DATE - 1, 4, 3, 7),
(CURRENT_DATE - 1, 3, 3, 8),
(CURRENT_DATE - 1, 2, 3, 9),

-- theme_id 4: 7건
(CURRENT_DATE - 7, 7, 4, 2),
(CURRENT_DATE - 7, 6, 4, 3),
(CURRENT_DATE - 7, 5, 4, 4),
(CURRENT_DATE - 7, 4, 4, 5),
(CURRENT_DATE - 7, 3, 4, 6),
(CURRENT_DATE - 7, 2, 4, 7),
(CURRENT_DATE - 7, 1, 4, 8),

-- theme_id 5: 6건
(CURRENT_DATE - 6, 6, 5, 2),
(CURRENT_DATE - 6, 5, 5, 3),
(CURRENT_DATE - 6, 4, 5, 4),
(CURRENT_DATE - 6, 3, 5, 5),
(CURRENT_DATE - 6, 2, 5, 6),
(CURRENT_DATE - 6, 1, 5, 7),

-- theme_id 6: 5건
(CURRENT_DATE - 5, 5, 6, 2),
(CURRENT_DATE - 5, 4, 6, 3),
(CURRENT_DATE - 5, 3, 6, 4),
(CURRENT_DATE - 5, 2, 6, 5),
(CURRENT_DATE - 5, 1, 6, 6),

-- theme_id 7: 4건
(CURRENT_DATE - 4, 4, 7, 2),
(CURRENT_DATE - 4, 3, 7, 3),
(CURRENT_DATE - 4, 2, 7, 4),
(CURRENT_DATE - 4, 1, 7, 5),

-- theme_id 8: 3건
(CURRENT_DATE - 3, 3, 8, 2),
(CURRENT_DATE - 3, 2, 8, 3),
(CURRENT_DATE - 3, 1, 8, 4),

-- theme_id 9: 2건
(CURRENT_DATE - 2, 2, 9, 2),
(CURRENT_DATE - 2, 1, 9, 3),

-- theme_id 10: 1건
(CURRENT_DATE - 1, 1, 10, 2);
