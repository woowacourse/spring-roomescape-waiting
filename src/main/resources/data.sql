...
VALUES ('예약자1', (SELECT id FROM reservation_slot WHERE `date` = '2026-06-10' AND time_id = 1 AND theme_id = 1),
        'CONFIRMED'),
...
VALUES ('대기자1', '2026-05-27 10:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-06-10' AND time_id = 1 AND theme_id = 1)),
       ('대기자2', '2026-05-27 11:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-06-10' AND time_id = 1 AND theme_id = 1)),
       ('대기자3', '2026-05-27 12:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-06-10' AND time_id = 1 AND theme_id = 1)),
       ('대기자4', '2026-05-27 10:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-06-11' AND time_id = 1 AND theme_id = 1)),
       ('대기자5', '2026-05-27 11:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-06-11' AND time_id = 1 AND theme_id = 1)),
       ('대기자6', '2026-05-27 10:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-05-12' AND time_id = 1 AND theme_id = 2)),
       ('대기자7', '2026-05-27 11:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-05-12' AND time_id = 1 AND theme_id = 2)),
       ('브라운', '2026-05-27 13:00:00',
        (SELECT id FROM reservation_slot WHERE `date` = '2026-06-10' AND time_id = 1 AND theme_id = 1));
