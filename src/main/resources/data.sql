...
-- RESERVATION: 개별 예약자 (slot_id 참조)
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (1,  '김철수', 'APPROVED', '2026-05-21 09:12:33');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (2,  '이영희', 'APPROVED', '2026-05-21 11:45:07');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (3,  '박민수', 'APPROVED', '2026-05-22 14:30:51');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (4,  '홍길동', 'APPROVED', '2026-05-22 18:05:22');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (5,  '정수진', 'APPROVED', '2026-05-23 21:40:18');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (6,  '한동훈', 'APPROVED', '2026-05-24 08:15:44');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (7,  '임채원', 'APPROVED', '2026-05-24 10:50:09');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (8,  '서태양', 'APPROVED', '2026-05-25 13:22:37');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (9,  '김철수', 'APPROVED', '2026-05-26 16:48:55');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (10, '유민호', 'APPROVED', '2026-05-28 20:11:02');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (11, '강민준', 'APPROVED', '2026-05-20 07:33:19');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (12, '조현아', 'APPROVED', '2026-05-22 09:58:41');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (13, '김철수', 'APPROVED', '2026-05-23 12:27:06');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (14, '홍길동', 'APPROVED', '2026-05-24 15:44:50');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (15, '황준혁', 'APPROVED', '2026-05-25 19:09:28');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (16, '송미래', 'APPROVED', '2026-05-26 08:41:13');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (17, '안태양', 'APPROVED', '2026-05-27 11:16:39');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (18, '배소희', 'APPROVED', '2026-05-29 14:52:04');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (19, '권지훈', 'APPROVED', '2026-05-22 17:30:47');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (20, '홍길동', 'APPROVED', '2026-05-23 20:55:21');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (21, '김철수', 'APPROVED', '2026-05-25 09:05:58');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (22, '류지아', 'APPROVED', '2026-05-26 12:38:16');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (23, '서태양', 'APPROVED', '2026-05-27 15:11:33');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (24, '서태양', 'APPROVED', '2026-05-29 18:47:09');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (25, '홍길동', 'APPROVED', '2026-05-23 08:23:42');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (26, '전현무', 'APPROVED', '2026-05-25 10:59:27');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (27, '서태양', 'APPROVED', '2026-05-26 13:34:50');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (28, '표민혁', 'APPROVED', '2026-05-27 16:20:15');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (29, '서태양', 'APPROVED', '2026-05-24 19:48:33');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (30, '홍길동', 'APPROVED', '2026-05-28 09:14:06');

-- 같은 슬롯(slot_id=1) 대기 테스트용
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (1, '대기자A', 'WAITING', '2026-05-21 09:30:00');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (1, '대기자B', 'WAITING', '2026-05-21 10:00:00');
INSERT INTO RESERVATION (slot_id, name, status, created_at) VALUES (1, '대기자C', 'WAITING', '2026-05-21 10:30:00');
