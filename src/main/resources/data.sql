...
-- 테마 1 예약 목록 : 5개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 1, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 1, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 1, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 4, 1, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 1, 1);
...
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 4, 2, 1);

-- 테마 3 예약 목록 : 2개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 3, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 3, 1);

-- 테마 4 예약 목록 : 5개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 4, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 4, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 4, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 4, 4, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 4, 1);

-- 테마 5 예약 목록 : 2개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 5, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 5, 1);

-- 테마 6 예약 목록 : 3개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 6, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 6, 1);
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 6, 1);

-- 테마 7 예약 목록
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 7, 1);

-- 테마 8 예약 목록
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 8, 1);

-- 테마 9 예약 목록
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 9, 1);

-- 테마 10 예약 목록
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 10, 1);

-- 테마 11 예약 목록
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 11, 1);
