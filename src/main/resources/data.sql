...
VALUES ('공포의 저택', '버려진 저택에서 탈출하라! 어둠 속에 숨겨진 비밀을 밝혀야 살 수 있다.', 'https://picsum.photos/seed/haunted/400/250');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('우주 정거장', '고장난 우주 정거장에서 살아남아라. 산소가 30분 후면 바닥난다!', 'https://picsum.photos/seed/spacestation/400/250');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('마법사의 연구실', '미친 마법사의 연구실에서 탈출하라. 다음 실험 대상이 되기 전에!', 'https://picsum.photos/seed/wizard/400/250');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('탐정 사무소', '살인 사건의 유일한 용의자가 되었다. 진범을 찾아 무죄를 증명하라.', 'https://picsum.photos/seed/detective/400/250');
...
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('러로', 1, 'RESERVED', '2026-05-20 09:00:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('현미밥', 2, 'WAITING', '2026-05-21 09:30:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('오뚜기밥', 3, 'CANCELED', '2026-05-30 18:00:00');

-- 2026-06-02 공포의 저택 10:00: one confirmed reservation, two waiting reservations, one canceled history.
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('러로', 4, 'RESERVED', '2026-05-31 09:00:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('현미밥', 4, 'WAITING', '2026-05-31 09:05:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('오뚜기밥', 4, 'WAITING', '2026-05-31 09:10:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('잡곡밥', 4, 'CANCELED', '2026-05-31 09:15:00');

-- 2026-06-03 우주 정거장 14:00: waiting order can be checked clearly.
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('잡곡밥', 5, 'RESERVED', '2026-05-31 10:00:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('흑미밥', 5, 'WAITING', '2026-05-31 10:05:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('흰쌀밥', 5, 'WAITING', '2026-05-31 10:10:00');

-- Other future schedules for admin/user screens.
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('흰쌀밥', 6, 'RESERVED', '2026-05-31 11:00:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('러로', 6, 'CANCELED', '2026-05-31 11:20:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('현미밥', 7, 'RESERVED', '2026-05-31 12:00:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('오뚜기밥', 8, 'RESERVED', '2026-05-31 13:00:00');
INSERT INTO reservation (name, schedule_id, status, updated_at)
VALUES ('흑미밥', 9, 'CANCELED', '2026-05-31 14:00:00');
