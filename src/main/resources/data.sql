...
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 1, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 1, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 4, 1, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 1, 1, 'APPROVED');

-- 테마 2 예약 목록 : 4개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 2, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 2, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 2, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 4, 2, 1, 'APPROVED');

-- 테마 3 예약 목록 : 2개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 3, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 3, 1, 'APPROVED');

-- 테마 4 예약 목록 : 5개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 4, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 4, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 4, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 4, 4, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 4, 1, 'APPROVED');

-- 테마 5 예약 목록 : 2개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 5, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 5, 5, 1, 'APPROVED');

-- 테마 6 예약 목록 : 3개
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 1, 6, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 6, 1, 'APPROVED');
INSERT INTO reservation (date, time_id, theme_id, reservation_member_id, status)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 6, 1, 'APPROVED');
