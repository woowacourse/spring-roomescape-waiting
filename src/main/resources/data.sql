...
INSERT INTO reservation (member_id, date, time_id, theme_id, created_at) VALUES ( 2, FORMATDATETIME(DATEADD('DAY', -3, NOW()), 'yyyy-MM-dd'), 1, 1, '2000-05-11 12:00:00');
INSERT INTO reservation (member_id, date, time_id, theme_id, created_at) VALUES ( 1, FORMATDATETIME(DATEADD('DAY', -3, NOW()), 'yyyy-MM-dd'), 1, 2, '2000-05-11 12:00:00');
INSERT INTO reservation (member_id, date, time_id, theme_id, created_at) VALUES ( 2, FORMATDATETIME(DATEADD('DAY', -2, NOW()), 'yyyy-MM-dd'), 1, 1, '2000-05-11 12:00:00');
INSERT INTO reservation (member_id, date, time_id, theme_id, created_at) VALUES ( 1, FORMATDATETIME(DATEADD('DAY', -4, NOW()), 'yyyy-MM-dd'), 1, 2, '2000-05-11 12:00:00');
INSERT INTO reservation (member_id, date, time_id, theme_id, created_at) VALUES ( 1, FORMATDATETIME(DATEADD('DAY', -2, NOW()), 'yyyy-MM-dd'), 1, 2, '2000-05-11 12:00:00');
INSERT INTO reservation (member_id, date, time_id, theme_id, created_at) VALUES ( 1, FORMATDATETIME(DATEADD('DAY', -2, NOW()), 'yyyy-MM-dd'), 1, 3, '2000-05-11 12:00:00');
