...
-- slot
-- 인기 테마 산정 기준: 2026-05-15 기준 최근 7일(05-08 ~ 05-14)에 해당하는 슬롯들
INSERT INTO slot (`date`, time_id, theme_id)
VALUES ('2026-05-14', 1, 1), -- id 1
       ('2026-05-14', 2, 1), -- id 2
       ('2026-05-13', 3, 1), -- id 3
       ('2026-05-13', 4, 1), -- id 4
       ('2026-05-12', 5, 1), -- id 5
       ...
       ('2026-05-10', 3, 1), -- id 8
       ('2026-05-09', 4, 1), -- id 9
       ('2026-05-08', 5, 1); -- id 10

INSERT INTO slot (`date`, time_id, theme_id)
VALUES ('2026-05-14', 1, 2), -- id 11
       ('2026-05-14', 2, 2), -- id 12
       ('2026-05-13', 3, 2), -- id 13
       ('2026-05-13', 4, 2), -- id 14
       ('2026-05-12', 5, 2), -- id 15
       ('2026-05-11', 6, 2), -- id 16
       ('2026-05-10', 7, 2), -- id 17
       ('2026-05-09', 1, 2); -- id 18

INSERT INTO slot (`date`, time_id, theme_id)
VALUES ('2026-05-14', 1, 3), -- id 19
       ('2026-05-13', 2, 3), -- id 20
       ('2026-05-12', 3, 3), -- id 21
       ('2026-05-11', 4, 3), -- id 22
       ('2026-05-10', 5, 3), -- id 23
       ('2026-05-09', 6, 3); -- id 24

INSERT INTO slot (`date`, time_id, theme_id)
VALUES ('2026-05-14', 1, 4), -- id 25
       ('2026-05-13', 2, 4), -- id 26
       ('2026-05-12', 3, 4), -- id 27
       ('2026-05-11', 4, 4); -- id 28

-- 미래 예약용 슬롯
INSERT INTO slot (`date`, time_id, theme_id)
VALUES ('2026-05-15', 10, 1), -- id 29
       ('2026-05-16', 11, 2), -- id 30
       ('2026-05-17', 12, 3); -- id 31
