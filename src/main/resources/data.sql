...
VALUES
    (2, '2025-05-29', 2, 1, 'RESERVED'),
    (3, '2025-05-28', 3, 2, 'RESERVED'),
    (2, '2025-05-27', 1, 1, 'RESERVED'),
    (3, '2025-05-26', 2, 2, 'RESERVED'),
    (2, '2025-05-25', 3, 1, 'RESERVED'),
    (3, '2025-05-24', 1, 2, 'RESERVED'),
    (2, '2025-05-23', 2, 1, 'RESERVED'),
    (3, '2025-05-22', 3, 2, 'RESERVED'),
    (2, '2025-05-21', 1, 1, 'RESERVED'),
    (3, '2025-05-20', 2, 2, 'RESERVED'),
    (2, '2025-05-30', 2, 2, 'RESERVED'),
    (3, '2025-05-31', 3, 1, 'RESERVED'),
    (2, '2025-06-01', 1, 2, 'RESERVED'),
    (3, '2025-06-02', 2, 1, 'RESERVED'),
    (2, '2025-06-03', 3, 2, 'RESERVED'),
    (3, '2025-06-04', 1, 1, 'RESERVED'),
    (2, '2025-06-05', 2, 2, 'RESERVED');
