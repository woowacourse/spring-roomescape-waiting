...
VALUES
    ...
    ('tester1', 1, 2, 'WAITING', DATEADD('DAY', +1, CURRENT_TIMESTAMP)),
    ('tester2', 1, 2, 'WAITING', DATEADD('DAY', +2, CURRENT_TIMESTAMP)),
    ('tester3', 1, 2, 'WAITING', DATEADD('DAY', +3, CURRENT_TIMESTAMP)),
    ('tester4', 1, 2, 'WAITING', DATEADD('DAY', +4, CURRENT_TIMESTAMP)),
    ('tester5', 1, 2, 'WAITING', DATEADD('DAY', +5, CURRENT_TIMESTAMP)),
    ('tester6', 1, 2, 'WAITING', DATEADD('DAY', +6, CURRENT_TIMESTAMP)),
